...
export const metadata = { title: "Sunset Cruise" };

export default function SunsetCruisePage() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <Image src={PAGE_BACKGROUNDS["sunset-cruise"]} alt="" fill className="object-cover" sizes="100vw" priority />
      ...
      <div className="relative z-10 text-center max-w-md px-5">
        ...
        <h1 className="font-display text-section" style={{ color: "var(--color-sand-50)" }}>Sunset Cruise</h1>
