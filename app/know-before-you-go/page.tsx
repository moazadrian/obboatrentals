...
export const metadata = { title: "Know Before You Go" };

export default function KnowBeforeYouGoPage() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <Image src={PAGE_BACKGROUNDS["know-before-you-go"]} alt="" fill className="object-cover" sizes="100vw" priority />
      ...
      <div className="relative z-10 text-center max-w-md px-5">
        ...
        <h1 className="font-display text-section" style={{ color: "var(--color-sand-50)" }}>Know Before You Go</h1>
